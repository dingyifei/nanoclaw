  ...
  for await (const message of query({
    ...
    options: {
      ...
      allowedTools: [
        ...
        'NotebookEdit',
        'mcp__nanoclaw__*',
        ...(process.env.APPIUM_BRIDGE_URL ? ['mcp__appium__*'] : []),
      ],
      env: sdkEnv,
      ...
      mcpServers: {
        ...
        ...(process.env.APPIUM_BRIDGE_URL ? {
          appium: {
            type: 'http' as const,
            url: process.env.APPIUM_BRIDGE_URL,
            headers: {
              'Authorization': `Bearer ${process.env.APPIUM_BRIDGE_TOKEN}`,
            },
          },
        } : {}),
      },
