...
For any task that takes longer than 30 seconds, send a brief progress update to the group after completing each major step using `mcp__nanoclaw__send_message`. Keep updates short (1-2 sentences). Examples:
- "Cloned the repo and created branch `fix/login-bug`."
- "Tests passing. Pushing and creating PR now."
- "Build complete. Restarting the service."

Do not wait until the end to report — update as you go.
